...
/// <summary>
/// MSTest adapter for Betterer. A thin wrapper over <see cref="BettererAssertions"/> that fails the
/// MSTest test (via <c>Assert.Fail</c>) when a result is new without opt-in, regresses, or expires.
/// </summary>
